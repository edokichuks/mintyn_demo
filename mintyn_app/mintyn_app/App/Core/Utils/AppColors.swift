...
enum AppColors {
    ...
    static let homeNavigationBackground = dynamic(light: "#FFFFFF", dark: "#242424")
    static let homeNavigationOverlay = dynamic(light: "#FFFFFF", dark: "#242424", alpha: 0)
    static let homeNavigationBorder = dynamic(light: "#F1EFEA", dark: "#353535")
    static let homeNavigationTopGlow = dynamic(light: "#FFFFFF", dark: "#242424", alpha: 0)
    static let homeNavigationSelectedBackground = dynamic(light: "#ECECEC", dark: "#434343")
    static let homeNavigationShadow = dynamic(light: "#CFC8BD", dark: "#000000", alpha: 0.22)
    static let homeNavigationInactive = dynamic(light: "#1F1B17", dark: "#F7F3EC")
    static let homeNavigationCenterButtonStart = dynamic(light: "#D3A73F", dark: "#D5AE4D")
    static let homeNavigationCenterButtonEnd = dynamic(light: "#996733", dark: "#8C6132")
    static let homeNavigationCenterButtonShadow = dynamic(light: "#7B5B26", dark: "#000000", alpha: 0.24)
